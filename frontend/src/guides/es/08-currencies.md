...
Si las finanzas del hogar se basan en JPY, no es necesario crear asientos por las variaciones de precio de los criptoactivos. En una compra, registra los JPY pagados y la cantidad adquirida; en una venta, los JPY recibidos y la cantidad dispuesta; y en un pago directo con criptoactivos, el importe del gasto y la cantidad dispuesta. Las conversiones mostradas son información de referencia y no modifican el libro contable.

Puedes mantener el mismo BTC para ambos fines. Las cuentas separadas conservan los saldos distintos aunque el código de moneda sea el mismo, y la conciliación compara cada cuenta de forma independiente. Las cantidades de la billetera solo pueden obtenerse en las cuentas de inversión mientras BTC esté seleccionado en el encabezado; todas las cuentas, incluidas las de uso diario, permiten introducir el saldo real manualmente. Consulta la guía de Conciliación de saldos de criptoactivos.
